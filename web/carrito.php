            ...
            <div class="container">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" min="1" max="10" step="1" value="<?php  echo $cantidad ?>" id="cantidad_<?php echo $_id;?>" onchange="">
                                </td>
                                <td>$<?php echo $precio; ?></td>
                                <td>$<?php echo $subtotal; ?></td>
                                <td><a href="#" class="btn btn-dark" data-bs-id="
                                <?php echo $_id; ?>" data-bs-toogle="modal" data-bs-target="eliminaModal">Eliminar</a></td>
                            </tr>
                            <?php } ?>
                ...
                <div class="row">
                    <div class="col-md-5 offset-md-7 d-grid gap-2">
                        <button class="btn btn-outline-danger btn-lg">Realizar pago</button>
